...
const translations = {
  fr: {
    ...
    app_sec_pay: "Événements Tendances",
    app_via: "À ne pas manquer",
    // Features Section
    ...
    feat_3_desc: "Réservez vos places en quelques gestes. Votre panier est sécurisé pendant 10 minutes, le temps de confirmer votre choix.",
    feat_4_title: "Confirmation instantanée",
    feat_4_desc: "Vos billets sont générés immédiatement. Recevez votre accès dès que votre réservation est validée.",
    ...
    how_2_desc: "Choisissez vos places, ajoutez-les au panier et confirmez votre réservation en quelques instants.",
  ...
  en: {
    ...
    app_sec_pay: "Trending Events",
    app_via: "Tailored for you",
    // Features Section
    feat_badge: "Features",
    ...
    feat_3_desc: "Book your seats in a few steps. Your cart is secured for 10 minutes, giving you time to confirm your choice.",
    feat_4_title: "Instant Confirmation",
    feat_4_desc: "Tickets are generated immediately. Receive your access as soon as your reservation is confirmed.",
    ...
    how_2_title: "Book",
    how_2_desc: "Choose your seats, add them to the cart and confirm your reservation instantly in a few taps.",
    how_3_title: "Enjoy",
  ...
  function updateLanguage(lang) {
    ...
    document.querySelectorAll('[data-i18n]').forEach(el => {
      ...
      if (translations[lang][key]) {
        ...
        if (key.includes('title_') || key.includes('_desc') || key.includes('_text') || key.includes('notice') || key.includes('app_from') || key.includes('success')) {
